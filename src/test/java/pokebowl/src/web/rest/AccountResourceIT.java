...
import static pokebowl.src.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import pokebowl.src.IntegrationTest;
import pokebowl.src.config.Constants;
import pokebowl.src.domain.PersistentToken;
import pokebowl.src.domain.User;
import pokebowl.src.repository.AuthorityRepository;
import pokebowl.src.repository.PersistentTokenRepository;
import pokebowl.src.repository.UserRepository;
import pokebowl.src.security.AuthoritiesConstants;
import pokebowl.src.service.UserService;
import pokebowl.src.service.dto.AdminUserDTO;
import pokebowl.src.service.dto.PasswordChangeDTO;
import pokebowl.src.service.dto.UserDTO;
import pokebowl.src.web.rest.vm.KeyAndPasswordVM;
import pokebowl.src.web.rest.vm.ManagedUserVM;
